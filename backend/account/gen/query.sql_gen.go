...
const getAllocationByUserEmailAndTeamId = `-- name: GetAllocationByUserEmailAndTeamId :one
...
type GetAllocationByUserEmailAndTeamIdParams struct {
	Email  string `db:"email" json:"email"`
	TeamID int64  `db:"team_id" json:"teamId"`
}

type GetAllocationByUserEmailAndTeamIdRow struct {
...
func (q *Queries) GetAllocationByUserEmailAndTeamId(ctx context.Context, arg GetAllocationByUserEmailAndTeamIdParams) (GetAllocationByUserEmailAndTeamIdRow, error) {
	row := q.db.QueryRowContext(ctx, getAllocationByUserEmailAndTeamId, arg.Email, arg.TeamID)
	var i GetAllocationByUserEmailAndTeamIdRow
	err := row.Scan(
		&i.UserID,
		&i.TeamID,
		&i.ReadLevel,
